...
Public Class crMDLGridView
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EngDesignTrackingTestTest.crMDLGridView.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMDLGridView
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMDLGridView = New crMDLGridView()
        rpt.Site = Me.Site
        Return rpt
    End Function

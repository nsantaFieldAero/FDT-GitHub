Public Class frmEARRSubSignOffUsersPrograms
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        Else
            ...
            u.ExecuteSQL(SqlConnection1, "Update tblEARR Set QCName = '" & NewSubbedEmail & "' Where (QCName = '" & PreviousEmailSubEARR & "' OR QCName = '" & PreviousUsernameSubEARR & "') And QCSignOff = '01/01/1900' And ProgramName = '" & SubbedUserProgram & "'" & QueryForType & " And (EARRStatus = 'Pending' Or EARRStatus = 'Rescinded')")
            u.ExecuteSQL(SqlConnection1, "Update tblEARR Set QCNameBackup = '" & NewSubbedEmail & "' Where (QCNameBackup = '" & PreviousEmailSubEARR & "' OR QCNameBackup = '" & PreviousUsernameSubEARR & "') And QCSignOff = '01/01/1900' And ProgramName = '" & SubbedUserProgram & "'" & QueryForType & " And (EARRStatus = 'Pending' Or EARRStatus = 'Rescinded')")
            u.ExecuteSQL(SqlConnection1, "Update tblEARR Set Planner1 = '" & NewSubbedEmail & "' Where (Planner1 = '" & PreviousEmailSubEARR & "' OR Planner1 = '" & PreviousUsernameSubEARR & "') And PlannerSignOffDate = '01/01/1900' And ProgramName = '" & SubbedUserProgram & "'" & QueryForType & " And (EARRStatus = 'Pending' Or EARRStatus = 'Rescinded')")
            u.ExecuteSQL(SqlConnection1, "Update tblEARR Set Planner2 = '" & NewSubbedEmail & "' Where (Planner2 = '" & PreviousEmailSubEARR & "' OR Planner2 = '" & PreviousUsernameSubEARR & "') And PlannerSignOffDate = '01/01/1900' And ProgramName = '" & SubbedUserProgram & "'" & QueryForType & " And (EARRStatus = 'Aborted' Or EARRStatus = 'Rescinded')")
